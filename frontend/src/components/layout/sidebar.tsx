...
const sidebarItems = {
  student: [
    ...
    { icon: FileText, label: "Plan & Tasks", href: "/dashboard/student/applications" },
    { icon: Send, label: "Reports", href: "/dashboard/student/reports" },
    { icon: MessageSquare, label: "Messages", href: "/dashboard/student/messages" },
    { icon: Calendar, label: "Leave Requests", href: "/dashboard/student/leave" },
  ...
  company: [
    ...
    { icon: FileText, label: "Applications", href: "/dashboard/company/applications" },
    ...
    { icon: MessageSquare, label: "Messages", href: "/dashboard/company/messages" },
    { icon: Calendar, label: "Leave Management", href: "/dashboard/company/leave" },
    { icon: Bell, label: "Notifications", href: "/dashboard/company/notifications" },
  ...
  university: [
    ...
    { icon: FileText, label: "Applications", href: "/dashboard/university/applications" },
    { icon: Users, label: "Students", href: "/dashboard/university/students" },
    { icon: GraduationCap, label: "Supervisors", href: "/dashboard/university/supervisors" },
    { icon: Star, label: "Performance", href: "/dashboard/university/performance" },
    { icon: CheckCircle, label: "Evaluations", href: "/dashboard/university/evaluations" },
    { icon: MessageSquare, label: "Messages", href: "/dashboard/university/messages" },
    { icon: Calendar, label: "Schedules", href: "/dashboard/university/schedules" },
    { icon: Bell, label: "Notifications", href: "/dashboard/university/notifications" },
    { icon: Settings, label: "Settings", href: "/dashboard/university/settings" },
  ],
  admin: [
...
export function Sidebar({ userRole, userName, onLogout }: SidebarProps) {
  ...
  const roleColor = roleColors[userRole as keyof typeof roleColors] || "text-gray-600"
      ...
      >
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            {!isCollapsed && (
              <div>
                <h2 className="font-semibold text-gray-900 capitalize">{userRole} Portal</h2>
