...
export default function EvaluationsPage() {
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(18);
    doc.text("Internship Evaluation Report", pageWidth / 2, 20, {
      align: "center",
    });
    ...
    doc.text(`Generated on: ${today}`, pageWidth - margin, 10, {
      align: "right",
    });
    ...
    if (supervisorFilter !== "all")
      fileName += `_${supervisorFilter.replace(/\s+/g, "")}`;
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-2xl bg-white text-black">
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Detailed view of the company’s evaluation for the
                            student.
                          </DialogDescription>
                        </DialogHeader>
                        {selectedEvaluation && (
                          <div className="space-y-4">
                            <div>
                              ...
                              <p>{selectedEvaluation.student}</p>
                            </div>
                            <div>
                              <h3 className="font-semibold">Company</h3>
                              <p>{selectedEvaluation.company}</p>
                            </div>
                            <div>
                            ...
                            <div>
                              <h3 className="font-semibold">Company Rating</h3>
                              {renderStars(selectedEvaluation.companyRating)}
                            </div>
                            <div>
                              ...
                              <p className="text-sm text-gray-700">
                                {selectedEvaluation.companyFeedback}
                              </p>
                            </div>
                            <div className="flex items-center text-sm text-gray-500 space-x-4">
                              <span>
                                Submitted: {selectedEvaluation.submissionDate}
                              </span>
                              {selectedEvaluation.evaluationDate && (
                                <span>
                                  Evaluated: {selectedEvaluation.evaluationDate}
                                </span>
                              )}
                            </div>
                            <div>
