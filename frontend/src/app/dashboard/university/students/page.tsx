...
//   try {
//     if (search) {
//       studentsData = await searchStudents(search, page, 10);
//     } else if (supervisor !== "all") {
//       studentsData = await filterStudentsBySupervisor(supervisor, page, 10);
//     } else {
//       studentsData = await fetchStudents(page, 10);
//     }
//   } catch (error: any) {
...
//     "use server";
//     try {
//       const response = await assignSupervisor(data);
//       const { revalidatePath } = await import("next/cache");
//       revalidatePath("/dashboard/university/students");
//       // Fetch updated student data to ensure the UI reflects the new supervisor
//       const updatedStudents = await fetchStudents(page, 10);
//       return { success: true, message: response.message, students: updatedStudents.content };
//     } catch (error: any) {
...
//       let data;
//       if (search) {
//         data = await searchStudents(search, page, size);
//       } else if (supervisor !== "all") {
//         data = await filterStudentsBySupervisor(supervisor, page, size);
//       } else {
//         data = await fetchStudents(page, size);
//       }
...
//     <DashboardLayout requiredRole="university">
//       <StudentsClient
//         initialStudents={studentsData.content}
//         pagination={{
//           currentPage: studentsData.number,
//           totalPages: studentsData.totalPages,
//           totalItems: studentsData.totalElements,
