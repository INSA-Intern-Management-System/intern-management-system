        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label htmlFor="evaluationReminders">Evaluation Reminders</Label>
                  <p className="text-sm text-gray-600">Get reminders for pending evaluations</p>
                </div>
                <Switch
                  id="evaluationReminders"
                  checked={settings.evaluationReminders}
                  onCheckedChange={(checked) => setSettings({ ...settings, evaluationReminders: checked })}
                />
              </div>
            </CardContent>
          </Card>
