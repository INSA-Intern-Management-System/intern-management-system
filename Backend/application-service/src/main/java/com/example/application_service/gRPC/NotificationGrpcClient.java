...
import com.example.notification.model.RecipientRole as JavaRecipientRole;
...
public class NotificationGrpcClient {
    ...
    public void sendNotification(Set<JavaRecipientRole> roles, String title, String description, Instant createdAt) {
